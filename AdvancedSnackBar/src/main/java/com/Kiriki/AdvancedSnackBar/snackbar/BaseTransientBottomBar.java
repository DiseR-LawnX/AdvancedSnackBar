...
abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
   ...
   *
   * @deprecated Use {@link com.Kiriki.AdvancedSnackBar.snackbar.ContentViewCallback} instead.
   */
  @Deprecated
  public interface ContentViewCallback
      extends com.Kiriki.AdvancedSnackBar.snackbar.ContentViewCallback {}
  ...
  private final com.Kiriki.AdvancedSnackBar.snackbar.ContentViewCallback contentViewCallback;
  ...
  protected BaseTransientBottomBar(
      ...
      @NonNull com.Kiriki.AdvancedSnackBar.snackbar.ContentViewCallback contentViewCallback) {
    if (parent == null) {
