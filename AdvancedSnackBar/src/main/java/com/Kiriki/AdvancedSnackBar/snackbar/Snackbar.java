...
package com.Kiriki.AdvancedSnackBar.snackbar;
...
class Snackbar extends BaseTransientBottomBar<Snackbar> {
   ...
   * @see #setDuration
   */
  protected static final int LENGTH_INDEFINITE = BaseTransientBottomBar.LENGTH_INDEFINITE;
   ...
   * @see #setDuration
   */
  protected static final int LENGTH_SHORT = BaseTransientBottomBar.LENGTH_SHORT;
   ...
   * @see #setDuration
   */
  protected static final int LENGTH_LONG = BaseTransientBottomBar.LENGTH_LONG;
  ...
  private Snackbar(
    ...
    super(parent, content, (com.Kiriki.AdvancedSnackBar.snackbar.ContentViewCallback) contentViewCallback);
    ...
    final SnackbarContentLayout content =
        (SnackbarContentLayout)
            inflater.inflate(
                ...
                parent,
                false);
    final Snackbar snackbar = new Snackbar(parent, content, (com.google.android.material.snackbar.ContentViewCallback) content);
   ...
   */
  @RestrictTo(LIBRARY_GROUP)
  static final class SnackbarLayout extends BaseTransientBottomBar.SnackbarBaseLayout {
